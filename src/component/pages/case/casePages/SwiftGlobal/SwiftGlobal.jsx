    ...
    return (
        <>
            ...
            <CaseTasks title1='Брендинг'
                       text1='Разработать фирменный стиль компании который передаст их ценности и подход к работе'
                       title2='Лендинг'
                       text2='Сделать Лендинг, который расскажет потенциальному клиенту о главном и соберет их заявки'
                       title3='Многостраничный сайт'
                       text3='Сделать сайт, который в подробностях расскажет обо всех аспектах работы компании, их услугах и позволит бронировать металлы на покупку'/>
            ...
            <CaseTitle title='Лендинг'
                       ...
                       text2='В итоге получился минималистичный и в то же время информативный лендинг, который подходит для людей которые только узнали о компании'/>
